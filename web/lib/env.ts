...
export const env = {
  ...
  get PROPSTACK_LEAD_SOURCE_ID() {
    return readEnv("PROPSTACK_LEAD_SOURCE_ID");
  },
  get PROPSTACK_LEAD_SOURCE_NAME() {
    return readEnv("PROPSTACK_LEAD_SOURCE_NAME");
  },
  get PROPSTACK_LEAD_PROPERTY_STATUS_ID() {
    return readEnv("PROPSTACK_LEAD_PROPERTY_STATUS_ID");
  },
  get PROPSTACK_LEAD_PROPERTY_STATUS_NAME() {
    return readEnv("PROPSTACK_LEAD_PROPERTY_STATUS_NAME");
  },
  get PROPSTACK_LEAD_ACTIVITY_TYPE_ID() {
    return readEnv("PROPSTACK_LEAD_ACTIVITY_TYPE_ID");
  },
  get PROPSTACK_LEAD_ACTIVITY_TYPE_NAME() {
    return readEnv("PROPSTACK_LEAD_ACTIVITY_TYPE_NAME");
  },
  get PROPSTACK_LEAD_PIPELINE_NAME() {
    return readEnv("PROPSTACK_LEAD_PIPELINE_NAME");
  },
  get PROPSTACK_LEAD_STAGE_NAME() {
    return readEnv("PROPSTACK_LEAD_STAGE_NAME");
  },
