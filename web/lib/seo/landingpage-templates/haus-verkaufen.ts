...
export const hausVerkaufenTemplate: LandingTemplate = {
  ...
  h1: (location) => `Haus verkaufen ${formatLocationPhraseFromName(location)}`,
  title: (location) => `Haus verkaufen ${formatLocationPhraseFromName(location)} | Frisia Immobilien`,
  description: (location) =>
    `Hausverkauf ${formatLocationPhraseFromName(location)}: klare Preisstrategie, geprüfte Käufer und strukturierte Begleitung bis zum Notartermin.`,
  intro: () =>
  ...
  faq: (location) => [
    {
      question: `Wie starte ich den Hausverkauf ${formatLocationPhraseFromName(location)} richtig?`,
      answer:
        `Der Hausverkauf startet mit einer realistischen Einordnung des Hauses. Dazu gehören Lage, Zustand, Grundstück, Wohnfläche, Modernisierung, Energie, Nachfrage und vergleichbare Angebote ${formatLocationPhraseFromName(location)}. Erst danach sollte entschieden werden, mit welchem Preis und welcher Strategie das Haus angeboten wird.`,
    },
    {
    ...
    {
      question: `Wie lange dauert ein Hausverkauf ${formatLocationPhraseFromName(location)}?`,
      answer:
    ...
    {
      question: `Warum sollte ich mein Haus ${formatLocationPhraseFromName(location)} mit Frisia Immobilien verkaufen?`,
      answer:
